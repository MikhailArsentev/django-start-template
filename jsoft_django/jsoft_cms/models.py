...
class Page(models.Model):
    ...
    img_preview         = models.ImageField('Картинка для анонса', upload_to='upload/media/%Y/%m/%d/',blank=True, null=True)
    img_detail          = models.ImageField('Детальная картинка', upload_to='upload/media/%Y/%m/%d/',blank=True, null=True)
    img_og              = models.ImageField('Картинка для Open graph', upload_to='upload/media/%Y/%m/%d/',blank=True, null=True)
...
class PageImg(models.Model):
    ...
    img                 = models.ImageField('Изображение', upload_to='upload/media/%Y/%m/%d/')
